...
: Node("MovementNode")
{
  ...
  moving_objects_pub_ = create_publisher<MovingObjectMsg>("/object_analytics/movement",10);
...
CLASS_LOADER_REGISTER_CLASS(object_analytics_node::movement::MovementNode, rclcpp::Node)